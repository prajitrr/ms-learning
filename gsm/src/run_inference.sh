...
NUM_SAMPLES_PER_SPECTRUM=10  # Generate 10 structures per spectrum for top-K

# Run inference with refinement
# NOTE: Removed --num_samples limit to process entire validation set
python inference.py \
